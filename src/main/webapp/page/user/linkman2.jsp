                    ...
                    <div style="width: 120px">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" style="width: 150px;margin-top: 10px">
                                <a class="btn btn-primary">外部联系人</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"
                                       aria-controls="home2">联系人列表</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"
                                       aria-controls="profile2">添加外部联系人</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="home2" role="tabpanel">
                                    ...
                                    <form id="form" action="${pageContext.request.contextPath}/user/deleteInternals"
                                          method="post">
                                            ...
                                            <c:forEach items="${pageInfo.list}" var="list">
                                                <tr>
                                                    ...
                                                    <td><a href="javascript:void(0);">
                                                        ...
                                                        <a href="javascript:deleteLinkman(${list.id});"
                                                           class="text-right">
                                ...
                                <div class="tab-pane" id="profile2" role="tabpanel">
                                    <table class="table  table-light">
                                        <form class="form-control-file"
                                              action="${pageContext.request.contextPath}/user/addExternal" method="post">
                                            ...
                                            <div class="row form-group">
                                                <label for="internal" class="col-sm-3 control-label"
                                                       style="margin-left: 50px">联系人:</label>
                                                <div class="col-sm-5">
