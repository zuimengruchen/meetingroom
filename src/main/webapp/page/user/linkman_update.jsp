...
<div class="content">
    <div class="container-fluid">
        <div class="card-header bg-light">
            <a href="#">首页</a><span>&nbsp&nbsp >&nbsp&nbsp  </span><a href="#">联系人管理</a><span>&nbsp&nbsp >&nbsp&nbsp  </span><a href="#">联系人修改</a>
        </div>
        <hr>
        <div >
            <div >
                <div class="row">
                    <div class="modal-body ">
                        <form class="form-control-file" action="${pageContext.request.contextPath}/user/updateLinkman" method="post">
                            <div class="form-group" id="room">
                                <label for="id" class="col-sm-2 control-label"></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="id" name="id" value="${user.id}" placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="dept" name="dept" value="${user.dept}" placeholder="">
                                </div>
                              <%--  <div class="col-sm-5">
                                    <select  id="dept" name="dept" class="form-control"
                                             style="width: 150px;height:35px"
                                             onchange="okIS(this.options[selectedIndex].value)" >
                                        <option value="武汉分部" <c:if test="${meetRoom.isStart=='1'}">selected='selected'</c:if>>武汉分部</option>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="sex" name="sex" value="${user.sex}"  placeholder="">
                                </div>
                            </div>
                            <div class="row form-group">
                                <span class="col-sm-1 control-label"></span>
                            ...
                            <%--<div class="row form-group">
                                ...
                                <div class="col-sm-5">
                                    <select  id="internal" name="internal" class="form-control"
                                             style="width: 150px;height:35px"
                                             onchange="okIS(this.options[selectedIndex].value)" >
                                        <option value="0" <c:if test="${user.internal=='0'}">selected='selected'</c:if>>内部</option>
                                        <option value="1" <c:if test="${user.internal=='1'}">selected='selected'</c:if>>外部</option>
                                    </select>
                                </div>
                            </div>--%>
                            <div class="row form-group">
                                ...
                                <div class="col-sm-5">
                                    <select  id="internal" name="internal" class="form-control"
                                             style="width: 150px;height:35px"
                                             onchange="okIS(this.options[selectedIndex].value)" >
                                        <option value="0" <c:if test="${user.internal=='2'}">selected='selected'</c:if>>内部</option>
                                        <option value="1" <c:if test="${user.internal=='1'}">selected='selected'</c:if>>外部</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="status" name="status" value="${user.status}"  placeholder="">
                                </div>
                            </div>
